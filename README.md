...
### Computer Engineering | Software Engineer | Cloud & Infrastructure Operations | AWS | Linux | Terraform | Observability
...
| [Cloud Infrastructure Operations Lab](https://github.com/itamarsb/cloud-infrastructure-operations-lab) | AWS Operations · Linux · Zabbix · Docker | Hands-on infrastructure operations portfolio focused on Linux administration, cloud operations, monitoring, troubleshooting and practical infrastructure operations. |
...
| [Zabbix NOC Operations Lab](https://github.com/itamarsb/zabbix-linux-network-server-monitoring-lab) | Zabbix · Grafana · Linux · Windows · Docker · Docker Compose · Network · Monitoring · NOC | Hands-on laboratory for network monitoring, Linux servers, SNMP, Zabbix, Grafana, alerts, and secure remote access. |
...
OpenTelemetry · Prometheus · Grafana · Loki · Tempo · Alertmanager · Zabbix · k6

### Engineering Practices

Git · GitHub · GitHub Actions · CI/CD · Technical Documentation · Troubleshooting · Architecture Diagrams
